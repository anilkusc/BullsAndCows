...
func CreateGameRequest(URI string, userName string) {
	...
	window.Get("localStorage").Set("turn", gjson.Get(bodyString, "session.turn").String())
	window.Get("localStorage").Set("whosturn", gjson.Get(bodyString, "session.predictor").String())
	...
	window.Get("localStorage").Set("start", gjson.Get(bodyString, "session.start").String())
